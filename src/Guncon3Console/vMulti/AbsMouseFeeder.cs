...
namespace Guncon3Console.vMulti
{
    ...
    internal sealed class VMultiAbsMouseFeeder : IMouseFeeder
    {
        ...
        private readonly Dictionary<GunButton, TetherScript.MouseButton> _mapping = new Dictionary<GunButton, TetherScript.MouseButton>();
        ...
        public void Connect()
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    _connected = true;
                    DoLog($"OutputReportByteLength={_outputReportByteLength}");
                    return;
                }
            }
            finally
